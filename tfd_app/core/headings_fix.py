...
def _build_report_data(applied, low_conf, skipped_residue, style_info):
...
def _build_change_docx(applied, low_conf, skipped_residue, style_info, dst_docx):
    ...
    summary, columns, rows = _build_report_data(applied, low_conf, skipped_residue, style_info)
    write_change_report(
        dst_docx,
...
def main():
    ...
    if xlsx_path:
        summary, columns, rows = _build_report_data(applied, low_conf, skipped, sinfo)
