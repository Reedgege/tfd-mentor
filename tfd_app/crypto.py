...
离线码格式（与 tools/reedmentor*.py 共用）：
...
# 私钥绝不出现在此文件或任何安装包里。导师版与学生版/海外版密钥互不相同。
PUBLIC_KEY_PEM = """-----BEGIN RSA PUBLIC KEY-----

oqTGLe3e6WetYI77b25H7mZ1pqPnPMrFZQIDAQAB
-----END RSA PUBLIC KEY-----
"""
