...
为什么是 Ed25519：
    ...
    现在改成 **Ed25519 非对称签名（RFC 8032）**：
      * 私钥：只在卖家本机（`_signing_keys/mentor_ed25519_private.pem`，
...
# 与 _signing_keys/mentor_ed25519_private.pem 配对。私钥绝不出现在此文件或安装包。
# 导师版与学生版/海外版密钥互不相同，离线码不跨版通用。
PUBLIC_KEY_B64 = "LOPLo/U0ozTvma0z8Zg+FogZy55ZOzXjsFtJJImpUsc="
