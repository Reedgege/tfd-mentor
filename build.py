...
# v1.0.25：消杀软误报——关 UPX 压缩（--noupx）
# 背景：v1.0.24 被 Defender 误报，真凶是 GitHub Actions runner 预装了 UPX，
...
def _pyi_options():
    ...
    # v1.0.25：消杀软误报——显式关 UPX（GitHub Actions runner 预装 UPX，PyInstaller 会默认压缩；
