...
v1.0.31 redesign: the zip is now a PURE PORTABLE build. There are NO
...
use a cp1252 console, and printing Chinese filenames crashed CI in v1.0.30
...
# UnicodeEncodeError (this exact bug broke the v1.0.30 build). Reconfigure to
...
def main():
    ...
    ap.add_argument("--exe", required=True,
                    help="Main executable file name, e.g. 1.论文格式医生·导师版.exe")
    ap.add_argument("--product", required=True,
                    help="Display name (Chinese), e.g. 论文格式医生·导师版")
